...
const STATS = [
  { value: "UW–Madison", label: "Badger Tutor" },
...
export function UWHeroBanner({ mounted = false }: Props) {
  ...
  const slides = [
    ...
    {
      image:    bascomHall,
      headline: "Badger Excellence",
      sub:      "Academic support built for UW–Madison students",
      accent:   UW_DARK,
    },
  ];
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center pl-6 pr-40">
              ...
              >
                ...
                <span className="text-white text-xs font-bold tracking-widest uppercase">UW–Madison</span>
              </div>
              <h2
