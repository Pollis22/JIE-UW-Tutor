...
export const VISUAL_TAGS = [
  ...
  // ── NEW BATCH — 113 visuals generated April 2026 ──
  // Math — K-2
  'new_counting_bears_sorting',
  'new_ten_frame_empty',
  'new_ten_frame_7',
  'new_part_part_whole',
  'new_ordinal_numbers_parade',
  'new_clock_analog_blank',
  'new_clock_hour_only',
  'new_coin_chart',
  'new_greater_less_alligator',
  // Math — Elementary
  'new_skip_count_2s',
  'new_skip_count_5s',
  'new_multiplication_array_3x4',
  'new_area_model_mult',
  'new_long_division_steps',
  'new_fraction_wall',
  'new_improper_to_mixed',
  'new_decimal_place_value',
  // Math — Middle
  'new_coordinate_plane_blank',
  'new_slope_rise_run',
  'new_angle_types',
  'new_parallel_lines_angles',
  'new_triangle_types_sides',
  'new_triangle_types_angles',
  'new_pythagorean_visual',
  'new_pemdas_diagram',
  'new_integer_number_line',
  'new_box_plot',
  'new_stem_leaf_plot',
  'new_volume_3d_formulas',
  'new_surface_area_nets',
  'new_probability_scale',
  'new_probability_tree',
  'new_transformations_grid',
  'new_absolute_value_line',
  'new_ratio_proportion',
  'new_percent_circle',
  // Math — High / College
  'new_scientific_notation',
  'new_parabola_features',
  'new_completing_square',
  'new_unit_circle',
  'new_soh_cah_toa',
  'new_log_exp_graph',
  'new_derivative_power_rule',
  'new_riemann_sum',
  'new_limit_visual',
  'new_matrix_mult',
  'new_normal_distribution',
  // Science
  'new_animal_cell',
  'new_plant_cell',
  'new_cell_membrane',
  'new_mitosis_stages',
  'new_meiosis_vs_mitosis',
  'new_dna_structure',
  'new_protein_synthesis',
  'new_food_web_forest',
  'new_nitrogen_cycle',
  'new_carbon_cycle',
  'new_darwin_finches',
  'new_bohr_model_oxygen',
  'new_periodic_table_color',
  'new_ionic_covalent_bond',
  'new_balance_equation',
  'new_states_of_matter',
  'new_heating_curve',
  'new_newtons_laws',
  'new_wave_properties',
  'new_em_spectrum',
  'new_circuit_series_parallel',
  'new_rock_cycle',
  'new_earth_layers',
  'new_tectonic_plates',
  'new_solar_system',
  'new_moon_phases',
  'new_human_skeleton',
  'new_digestive_system',
  'new_respiratory_system',
  'new_neuron_structure',
  'new_photosynthesis_diagram',
  // ELA
  'new_story_elements',
  'new_plot_mountain',
  'new_figurative_language',
  'new_text_structures',
  'new_paragraph_structure',
  'new_main_idea_details',
  'new_parts_of_speech_wheel',
  'new_point_of_view',
  'new_venn_diagram_compare',
  'new_authors_purpose_pie',
  'new_argument_structure',
  'new_thesis_builder',
  'new_essay_structure',
  // History
  'new_us_govt_three_branches',
  'new_checks_balances_web',
  'new_bill_to_law',
  'new_ancient_civ_timeline',
  'new_feudal_pyramid',
  'new_wwi_main_causes',
  'new_civil_rights_timeline',
  'new_supply_demand_graph',
  'new_constitution_structure',
  'new_cold_war_map',
  // Health
  'new_myplate_food_groups',
  'new_heart_anatomy',
  'new_blood_pressure_guide',
  'new_eye_anatomy',
  'new_sleep_cycle',
  'new_fight_flight',
  // Economics
  'new_circular_flow_econ',
  'new_economic_systems',
  'new_gdp_components',
  'new_maslow_hierarchy',
  'new_supply_demand_policy',
  // Writing
  'new_citation_mla_apa',
] as const;
...
const IMAGE_VISUALS: Record<string, string> = {
  ...
  // Math K-2
  new_counting_bears_sorting: '/images/visuals/counting_bears_sorting.webp',
  new_ten_frame_empty: '/images/visuals/ten_frame_empty.webp',
  new_ten_frame_7: '/images/visuals/ten_frame_7.webp',
  new_part_part_whole: '/images/visuals/part_part_whole.webp',
  new_ordinal_numbers_parade: '/images/visuals/ordinal_numbers_parade.webp',
  new_clock_analog_blank: '/images/visuals/clock_analog_blank.webp',
  new_clock_hour_only: '/images/visuals/clock_hour_only.webp',
  new_coin_chart: '/images/visuals/coin_chart.webp',
  new_greater_less_alligator: '/images/visuals/greater_less_alligator.webp',
  // Math Elementary
  new_skip_count_2s: '/images/visuals/skip_count_2s.webp',
  new_skip_count_5s: '/images/visuals/skip_count_5s.webp',
  new_multiplication_array_3x4: '/images/visuals/multiplication_array_3x4.webp',
  new_area_model_mult: '/images/visuals/area_model_mult.webp',
  new_long_division_steps: '/images/visuals/long_division_steps.webp',
  new_fraction_wall: '/images/visuals/fraction_wall.webp',
  new_improper_to_mixed: '/images/visuals/improper_to_mixed.webp',
  new_decimal_place_value: '/images/visuals/decimal_place_value.webp',
  // Math Middle
  new_coordinate_plane_blank: '/images/visuals/coordinate_plane_blank.webp',
  new_slope_rise_run: '/images/visuals/slope_rise_run.webp',
  new_angle_types: '/images/visuals/angle_types.webp',
  new_parallel_lines_angles: '/images/visuals/parallel_lines_angles.webp',
  new_triangle_types_sides: '/images/visuals/triangle_types_sides.webp',
  new_triangle_types_angles: '/images/visuals/triangle_types_angles.webp',
  new_pythagorean_visual: '/images/visuals/pythagorean_visual.webp',
  new_pemdas_diagram: '/images/visuals/pemdas_diagram.webp',
  new_integer_number_line: '/images/visuals/integer_number_line.webp',
  new_box_plot: '/images/visuals/box_plot.webp',
  new_stem_leaf_plot: '/images/visuals/stem_leaf_plot.webp',
  new_volume_3d_formulas: '/images/visuals/volume_3d_formulas.webp',
  new_surface_area_nets: '/images/visuals/surface_area_nets.webp',
  new_probability_scale: '/images/visuals/probability_scale.webp',
  new_probability_tree: '/images/visuals/probability_tree.webp',
  new_transformations_grid: '/images/visuals/transformations_grid.webp',
  new_absolute_value_line: '/images/visuals/absolute_value_line.webp',
  new_ratio_proportion: '/images/visuals/ratio_proportion.webp',
  new_percent_circle: '/images/visuals/percent_circle.webp',
  // Math High/College
  new_scientific_notation: '/images/visuals/scientific_notation.webp',
  new_parabola_features: '/images/visuals/parabola_features.webp',
  new_completing_square: '/images/visuals/completing_square.webp',
  new_unit_circle: '/images/visuals/unit_circle.webp',
  new_soh_cah_toa: '/images/visuals/soh_cah_toa.webp',
  new_log_exp_graph: '/images/visuals/log_exp_graph.webp',
  new_derivative_power_rule: '/images/visuals/derivative_power_rule.webp',
  new_riemann_sum: '/images/visuals/riemann_sum.webp',
  new_limit_visual: '/images/visuals/limit_visual.webp',
  new_matrix_mult: '/images/visuals/matrix_mult.webp',
  new_normal_distribution: '/images/visuals/normal_distribution.webp',
  // Science
  new_animal_cell: '/images/visuals/animal_cell.webp',
  new_plant_cell: '/images/visuals/plant_cell.webp',
  new_cell_membrane: '/images/visuals/cell_membrane.webp',
  new_mitosis_stages: '/images/visuals/mitosis_stages.webp',
  new_meiosis_vs_mitosis: '/images/visuals/meiosis_vs_mitosis.webp',
  new_dna_structure: '/images/visuals/dna_structure.webp',
  new_protein_synthesis: '/images/visuals/protein_synthesis.webp',
  new_food_web_forest: '/images/visuals/food_web_forest.webp',
  new_nitrogen_cycle: '/images/visuals/nitrogen_cycle.webp',
  new_carbon_cycle: '/images/visuals/carbon_cycle.webp',
  new_darwin_finches: '/images/visuals/darwin_finches.webp',
  new_bohr_model_oxygen: '/images/visuals/bohr_model_oxygen.webp',
  new_periodic_table_color: '/images/visuals/periodic_table_color.webp',
  new_ionic_covalent_bond: '/images/visuals/ionic_covalent_bond.webp',
  new_balance_equation: '/images/visuals/balance_equation.webp',
  new_states_of_matter: '/images/visuals/states_of_matter.webp',
  new_heating_curve: '/images/visuals/heating_curve.webp',
  new_newtons_laws: '/images/visuals/newtons_laws.webp',
  new_wave_properties: '/images/visuals/wave_properties.webp',
  new_em_spectrum: '/images/visuals/em_spectrum.webp',
  new_circuit_series_parallel: '/images/visuals/circuit_series_parallel.webp',
  new_rock_cycle: '/images/visuals/rock_cycle.webp',
  new_earth_layers: '/images/visuals/earth_layers.webp',
  new_tectonic_plates: '/images/visuals/tectonic_plates.webp',
  new_solar_system: '/images/visuals/solar_system.webp',
  new_moon_phases: '/images/visuals/moon_phases.webp',
  new_human_skeleton: '/images/visuals/human_skeleton.webp',
  new_digestive_system: '/images/visuals/digestive_system.webp',
  new_respiratory_system: '/images/visuals/respiratory_system.webp',
  new_neuron_structure: '/images/visuals/neuron_structure.webp',
  new_photosynthesis_diagram: '/images/visuals/photosynthesis_diagram.webp',
  // ELA
  new_story_elements: '/images/visuals/story_elements.webp',
  new_plot_mountain: '/images/visuals/plot_mountain.webp',
  new_figurative_language: '/images/visuals/figurative_language.webp',
  new_text_structures: '/images/visuals/text_structures.webp',
  new_paragraph_structure: '/images/visuals/paragraph_structure.webp',
  new_main_idea_details: '/images/visuals/main_idea_details.webp',
  new_parts_of_speech_wheel: '/images/visuals/parts_of_speech_wheel.webp',
  new_point_of_view: '/images/visuals/point_of_view.webp',
  new_venn_diagram_compare: '/images/visuals/venn_diagram_compare.webp',
  new_authors_purpose_pie: '/images/visuals/authors_purpose_pie.webp',
  new_argument_structure: '/images/visuals/argument_structure.webp',
  new_thesis_builder: '/images/visuals/thesis_builder.webp',
  new_essay_structure: '/images/visuals/essay_structure.webp',
  // History
  new_us_govt_three_branches: '/images/visuals/us_govt_three_branches.webp',
  new_checks_balances_web: '/images/visuals/checks_balances_web.webp',
  new_bill_to_law: '/images/visuals/bill_to_law.webp',
  new_ancient_civ_timeline: '/images/visuals/ancient_civ_timeline.webp',
  new_feudal_pyramid: '/images/visuals/feudal_pyramid.webp',
  new_wwi_main_causes: '/images/visuals/wwi_main_causes.webp',
  new_civil_rights_timeline: '/images/visuals/civil_rights_timeline.webp',
  new_supply_demand_graph: '/images/visuals/supply_demand_graph.webp',
  new_constitution_structure: '/images/visuals/constitution_structure.webp',
  new_cold_war_map: '/images/visuals/cold_war_map.webp',
  // Health
  new_myplate_food_groups: '/images/visuals/myplate_food_groups.webp',
  new_heart_anatomy: '/images/visuals/heart_anatomy.webp',
  new_blood_pressure_guide: '/images/visuals/blood_pressure_guide.webp',
  new_eye_anatomy: '/images/visuals/eye_anatomy.webp',
  new_sleep_cycle: '/images/visuals/sleep_cycle.webp',
  new_fight_flight: '/images/visuals/fight_flight.webp',
  // Economics
  new_circular_flow_econ: '/images/visuals/circular_flow_econ.webp',
  new_economic_systems: '/images/visuals/economic_systems.webp',
  new_gdp_components: '/images/visuals/gdp_components.webp',
  new_maslow_hierarchy: '/images/visuals/maslow_hierarchy.webp',
  new_supply_demand_policy: '/images/visuals/supply_demand_policy.webp',
  // Writing
  new_citation_mla_apa: '/images/visuals/citation_mla_apa.webp',
};
...
const VISUAL_LABELS: Record<VisualTag, string> = {
  ...
  // ── NEW BATCH — April 2026 ──────────────────────────────────
  new_counting_bears_sorting: 'Counting Bears Sorting Mat',
  new_ten_frame_empty: 'Ten Frame (Empty)',
  new_ten_frame_7: 'Ten Frame (Filled 7)',
  new_part_part_whole: 'Part-Part-Whole Mat',
  new_ordinal_numbers_parade: 'Ordinal Numbers Parade',
  new_clock_analog_blank: 'Analog Clock (Blank)',
  new_clock_hour_only: 'Clock — Hour Hand (3:00)',
  new_coin_chart: 'Coin Identification Chart',
  new_greater_less_alligator: 'Greater Than / Less Than',
  new_skip_count_2s: 'Skip Counting by 2s',
  new_skip_count_5s: 'Skip Counting by 5s',
  new_multiplication_array_3x4: 'Multiplication Array (3×4)',
  new_area_model_mult: 'Area Model Multiplication',
  new_long_division_steps: 'Long Division Steps',
  new_fraction_wall: 'Fraction Wall',
  new_improper_to_mixed: 'Improper Fraction → Mixed Number',
  new_decimal_place_value: 'Decimal Place Value Chart',
  new_coordinate_plane_blank: 'Coordinate Plane',
  new_slope_rise_run: 'Slope — Rise Over Run',
  new_angle_types: 'Types of Angles',
  new_parallel_lines_angles: 'Parallel Lines & Transversal',
  new_triangle_types_sides: 'Triangle Types (by Sides)',
  new_triangle_types_angles: 'Triangle Types (by Angles)',
  new_pythagorean_visual: 'Pythagorean Theorem',
  new_pemdas_diagram: 'Order of Operations (PEMDAS)',
  new_integer_number_line: 'Integer Number Line',
  new_box_plot: 'Box & Whisker Plot',
  new_stem_leaf_plot: 'Stem & Leaf Plot',
  new_volume_3d_formulas: 'Volume of 3D Shapes',
  new_surface_area_nets: 'Surface Area Nets',
  new_probability_scale: 'Probability Scale',
  new_probability_tree: 'Tree Diagram (Probability)',
  new_transformations_grid: 'Geometric Transformations',
  new_absolute_value_line: 'Absolute Value Number Line',
  new_ratio_proportion: 'Ratio & Proportion',
  new_percent_circle: 'Percent Circle Model',
  new_scientific_notation: 'Scientific Notation',
  new_parabola_features: 'Parabola Key Features',
  new_completing_square: 'Completing the Square',
  new_unit_circle: 'Unit Circle',
  new_soh_cah_toa: 'SOH-CAH-TOA',
  new_log_exp_graph: 'Logarithm vs Exponential',
  new_derivative_power_rule: 'Derivative Power Rule',
  new_riemann_sum: 'Riemann Sum',
  new_limit_visual: 'Limits — Approaching a Point',
  new_matrix_mult: 'Matrix Multiplication',
  new_normal_distribution: 'Normal Distribution',
  new_animal_cell: 'Animal Cell Diagram',
  new_plant_cell: 'Plant Cell Diagram',
  new_cell_membrane: 'Cell Membrane Structure',
  new_mitosis_stages: 'Mitosis Stages',
  new_meiosis_vs_mitosis: 'Meiosis vs Mitosis',
  new_dna_structure: 'DNA Double Helix',
  new_protein_synthesis: 'Protein Synthesis',
  new_food_web_forest: 'Food Web (Temperate Forest)',
  new_nitrogen_cycle: 'Nitrogen Cycle',
  new_carbon_cycle: 'Carbon Cycle',
  new_darwin_finches: "Darwin's Finches",
  new_bohr_model_oxygen: 'Bohr Model (Oxygen)',
  new_periodic_table_color: 'Periodic Table (Color-Coded)',
  new_ionic_covalent_bond: 'Ionic vs Covalent Bonds',
  new_balance_equation: 'Balancing Chemical Equations',
  new_states_of_matter: 'States of Matter',
  new_heating_curve: 'Heating Curve (Phase Changes)',
  new_newtons_laws: "Newton's Three Laws",
  new_wave_properties: 'Wave Properties',
  new_em_spectrum: 'Electromagnetic Spectrum',
  new_circuit_series_parallel: 'Series vs Parallel Circuits',
  new_rock_cycle: 'Rock Cycle',
  new_earth_layers: 'Layers of the Earth',
  new_tectonic_plates: 'Tectonic Plates',
  new_solar_system: 'Solar System',
  new_moon_phases: 'Moon Phases',
  new_human_skeleton: 'Human Skeleton',
  new_digestive_system: 'Digestive System',
  new_respiratory_system: 'Respiratory System',
  new_neuron_structure: 'Neuron Structure',
  new_photosynthesis_diagram: 'Photosynthesis',
  new_story_elements: 'Story Elements',
  new_plot_mountain: 'Plot Mountain / Story Arc',
  new_figurative_language: 'Figurative Language',
  new_text_structures: 'Text Structure Types',
  new_paragraph_structure: 'Paragraph Structure',
  new_main_idea_details: 'Main Idea & Details',
  new_parts_of_speech_wheel: 'Parts of Speech',
  new_point_of_view: 'Point of View',
  new_venn_diagram_compare: 'Venn Diagram',
  new_authors_purpose_pie: "Author's Purpose (PIE)",
  new_argument_structure: 'Argument Structure',
  new_thesis_builder: 'Thesis Statement Builder',
  new_essay_structure: 'Essay Structure',
  new_us_govt_three_branches: 'Three Branches of Government',
  new_checks_balances_web: 'Checks & Balances',
  new_bill_to_law: 'How a Bill Becomes a Law',
  new_ancient_civ_timeline: 'Ancient Civilizations Timeline',
  new_feudal_pyramid: 'Feudal System Pyramid',
  new_wwi_main_causes: 'Causes of WWI (MAIN)',
  new_civil_rights_timeline: 'Civil Rights Movement Timeline',
  new_supply_demand_graph: 'Supply & Demand Graph',
  new_constitution_structure: 'US Constitution Structure',
  new_cold_war_map: 'Cold War Map',
  new_myplate_food_groups: 'MyPlate Food Groups',
  new_heart_anatomy: 'Heart Anatomy',
  new_blood_pressure_guide: 'Blood Pressure Guide',
  new_eye_anatomy: 'Eye Anatomy',
  new_sleep_cycle: 'Sleep Cycle',
  new_fight_flight: 'Fight or Flight Response',
  new_circular_flow_econ: 'Circular Flow Model',
  new_economic_systems: 'Types of Economic Systems',
  new_gdp_components: 'GDP Components',
  new_maslow_hierarchy: "Maslow's Hierarchy of Needs",
  new_supply_demand_policy: 'Supply-Side vs Demand-Side Policy',
  new_citation_mla_apa: 'MLA vs APA Citation',
};
...
export function VisualPanel({ visualTag, onDismiss }: VisualPanelProps) {
  ...
  return (
    <div className="w-full flex-shrink-0 flex flex-col border-b-2 border-border bg-background overflow-hidden" style={{maxHeight: '42vh'}}>
      {/* Header */}
